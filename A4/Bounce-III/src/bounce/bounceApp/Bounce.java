...
public class Bounce extends JPanel {
	...
	private void populateModel() {
		...
		_model.add(new RectangleShape(20, 20, 4, 4, 200, 20, "Bounce"), root);
		_model.add(new RectangleShape(0, 0, 2, 2, 10, 10), root);
		_model.add(new DynamicRectangleShape(0, 0, 2, 3, 180, 130, Color.CYAN, "I change color when I bounce"), root);
